...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("CUSTOMER", "ORGANIZER", "GATE_STAFF", name="role"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PUBLISHED", "CANCELLED", name="event_status"),
            nullable=False,
        ),
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("AVAILABLE", "HOLD", "SOLD", name="seat_status"),
            nullable=False,
        ),
    ...
    op.create_foreign_key(
        "fk_seats_current_ticket_id_tickets",
        "seats",
        "tickets",
        ["current_ticket_id"],
        ["id"],
    ...
    op.create_table(
        ...
        sa.Column(
            "result",
            sa.Enum("APPROVED", "DECLINED", name="payment_result"),
            nullable=False,
        ),
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column(
...
def downgrade() -> None:
    ...
    op.drop_constraint(
        "fk_seats_current_ticket_id_tickets", "seats", type_="foreignkey"
    )
